...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="run">   
    <svg xmlns:svg="http://www.w3.org/2000/svg" width="575px" height="375px" xmlns:xlink="http://www.w3.org/1999/xlink">>
   ...
   <!--Draw and label horizontal axis-->
    ...
    <textPath dy="30" startOffset="40%" xlink:href="#generation">Generation</textPath>
    </text>
