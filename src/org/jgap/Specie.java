...
public final static String MUSHROOM_TAG = "mushroom";
public final static String FLOWER_TAG = "flower";
public final static String DEATH_TAG = "death";
public final static String KILL_TAG = "kill";
public final static String COLLISION_TAG = "collision";
public final static String BRICKS_TAG = "bricks";
 ...
 */
//EHSAN added Throws Illegal Argumant Exception
//EHSAN TODO REMOVE COMMENTS AND DEAL WITH IT
public double getChromosomeFitnessValue( Chromosome aChromosome ) throws IllegalArgumentException{
...
public String toXml() {
	...
	while ( chromIter.hasNext() ) {
		...
		result.append( chromToStore.getId() ).append( "\" " ).append( DISTANCE_TAG ).append( "=\"" );
		result.append( chromToStore.averageEval.distancePassedCells).append( "\" " );
		result.append( MUSHROOM_TAG ).append( "=\"" );
		result.append( chromToStore.averageEval.mushroomsDevoured).append( "\" " );
		result.append( KILL_TAG ).append( "=\"" );
		result.append( chromToStore.averageEval.killsTotal).append( "\" " );
		result.append(DEATH_TAG ).append( "=\"" );
		result.append( chromToStore.averageEval.cellWins).append( "\" " );
		result.append(COLLISION_TAG ).append( "=\"" );
		result.append( chromToStore.averageEval.collisionsWithCreatures).append( "\" " );
		result.append(BRICKS_TAG ).append( "=\"" );
		result.append( chromToStore.averageEval.bricksBumped).append( "\" " );
		result.append( FITNESS_TAG ).append( "=\"" );
