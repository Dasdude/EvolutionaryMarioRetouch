...
public static Logger logger = Logger.getLogger( TargetFitnessFunction.class );
...
public void init( Properties props ) {
	try {
		System.out.println("entering hsi init");
 ...
 */
//EHSAN Change method to final to return to default
public void evaluate( List genotypes ) {
	System.out.println("entering his Evaluation");
