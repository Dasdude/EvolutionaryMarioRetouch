 ...
 */
public double distance( Allele target ) throws ClassCastException{
	...
	//EHSAN important remove Try catch
...
public void setToRandomValue( Random a_numberGenerator ) {
	weight = MIN_INIT_WEIGHT
			+ ( a_numberGenerator.nextFloat() * ( MAX_INIT_WEIGHT - MIN_INIT_WEIGHT ) );
}
